...
## 作った目的
- あくまでも自分用ですがポートフォリオにも使えると思い公開します
- AIを利用して作成したライセンスなのでおかしなところがあった場合は"shtakegami@gmail.com"こちらまでご連絡お願いします
- 小型プロジェクト用なので細かい機能は導入していませんがカスタマイズできるのでご利用される場合はカスタマイズ前提でご利用お願いします
